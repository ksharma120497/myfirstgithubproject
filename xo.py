...
def score():
        if(btn10['text']=="             " or btn11['text']=="             " or btn12['text']=="             " or btn20['text']=="             " or btn21['text']=="             " or btn22['text']=="             " or btn30['text']=="             " or btn31['text']=="             " or btn32['text']=="             "):
                return 0 
        elif(btn10['text']==btn20['text'] and btn20['text']==btn30['text']):
                winner=btn10['text']
                messagebox.showinfo("Winner",winner+" wins! ")
        elif(btn11['text']==btn21['text'] and btn21['text']==btn31['text']):
                winner=btn11['text']
                messagebox.showinfo("Winner",winner+" wins!")
        elif(btn12['text']==btn22['text'] and btn22['text']==btn32['text']):
                winner=btn12['text']
                messagebox.showinfo("Winner",winner+" wins!")
        elif(btn10['text']==btn11['text'] and btn11['text']==btn12['text']):
                winner=btn10['text']
                messagebox.showinfo("Winner",winner+" wins!")
        elif(btn20['text']==btn21['text'] and btn21['text']==btn22['text']):
                winner=btn20['text']
                messagebox.showinfo("Winner",winner+" wins! ")
        elif(btn30['text']==btn31['text'] and btn31['text']==btn32['text']):
                winner=btn30['text']
                messagebox.showinfo("Winner",winner+" wins! ")
